...
plugins {
    ...
    id 'io.github.FlyJingFish.AndroidAop.android-aop' version '1.8.7' apply true
}
```
...
buildscript {
    dependencies {
        ...
        classpath 'io.github.FlyJingFish.ModuleCommunication:module-communication-plugin:1.2.6'
        //必须项 👇
        classpath 'io.github.FlyJingFish.AndroidAop:android-aop-plugin:1.8.7'
    }
}
plugins {
    //必须项 👇下边版本号根据你项目的 Kotlin 版本决定👇
...
dependencies {
    //必须项 👇AndroidAOP 提供支持
    implementation 'io.github.FlyJingFish.AndroidAop:android-aop-core:1.8.7'
    implementation 'io.github.FlyJingFish.AndroidAop:android-aop-annotation:1.8.7'
